...
import { handleGetUserPosts } from "@/utils/user/handleGetUserPosts";
import PostCard from "@/components/posts/PostCard";
import SharePostCard from "@/components/posts/SharePostCard";
import CreatePostModal from "@/components/posts/CreatePostModal";
import styles from "@/styles/user/UserPostPage.module.css";
...
export default function UserPostPage({ userId }: UserProps) {
  ...
  const fetchPosts = useCallback(async (pageNumber: number, forceRefresh = false) => {
    ...
    try {
      const { data, error } = await handleGetUserPosts(userId, pageNumber, 10);
